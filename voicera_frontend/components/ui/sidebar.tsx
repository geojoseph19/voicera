...
function SidebarProvider({
  ...
  // Read cookie state after hydration to avoid mismatch
  React.useEffect(() => {
    const cookies = document.cookie.split(";")
    const sidebarCookie = cookies.find((c) => c.trim().startsWith(`${SIDEBAR_COOKIE_NAME}=`))
    if (sidebarCookie) {
      const cookieValue = sidebarCookie.split("=")[1].trim() === "true"
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, hasHydrated]
  )
...
function Sidebar({
  ...
  const { isMobile, state, openMobile, setOpenMobile, hasHydrated } = useSidebar()
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          hasHydrated && "transition-[width] duration-200 ease-linear",
      ...
      <div
        ...
        className={cn(
          ...
          hasHydrated && "transition-[left,right,width] duration-200 ease-linear",
          side === "left"
