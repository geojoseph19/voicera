...
* [Welcome to VoicEra](README.md)

## Introduction

* [What is VoicEra](introduction/what-is-voicera.md)
...
* [Your first call](quickstart/first-call.md)
* [Default credentials](quickstart/default-credentials.md)
...
* [Dashboard tour](guides/operator/dashboard-tour.md)
* [Daily operations](guides/operator/operations.md)
* [FAQ](guides/operator/faq.md)

## Developer guides

* [Local setup](guides/developer/local-setup.md)
...
* [Endpoints cheatsheet](reference/endpoints-cheatsheet.md)
...
* [Voice and audio](troubleshooting/voice-and-audio.md)
* [Telephony](troubleshooting/telephony.md)
